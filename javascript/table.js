...
function confirmAdd() {
    ...
    // Clear hotkeys and setup edits to the row
    addListenerToClass("webTable_data", "click", editTable); // Re-add necessary event listeners
...
function cancelAdd() {
    ...
    // Now, delete the row and remove hotkeys
...
function editTable(e) {
    ...
    // Check to ensure that an edit isn't already being done or that a row was intended to be deleted
    if(document.getElementById("webTable_name")) {
        return;
    }
